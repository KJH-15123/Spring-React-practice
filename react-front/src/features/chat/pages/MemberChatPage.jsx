...
//멤버채팅도 가능하도록 구현해보기 (연결 및 확인 해보세요)
function MemberChatPage(){
    ...
    const {isConnected,message,connect,disconnect,sendMessage} = useWebsocket(`/member?token=${token}`);
    ...
    return (
        <div className='container'>
            <div className={styles.wrapper}>
                <h2 className={styles.title}>멤버 채팅 페이지</h2>
